...
tuple<double ,double *>  MC_paralel_kart_integrering(double local_a,double local_b, int local_n, int my_rank,double (*)(double, double, double, double, double, double));
...
tuple<double, double *> MC_paralel_kart_integrering(double a,double b, int n,int my_rank, double (*function)(double, double, double , double, double, double)){
...
// obtain a floating number x in [0,1]
        ...
        y2=a +(b-a)*y2;
         z2=a +(b-a)*z2;
        funk=(*function)(x1,y1,z1,x2,y2,z2);
        MCint+= funk;
        MCint_vek[i]= funk;
...
tuple<double, double *> MC_plaraisering_polar_integrering(double a,double b, int n,int my_rank, double (*function)(double, double, double , double, double, double)){
 ...
 // obtain a floating number x in [0,1]
          ...
          phi1=0 +(2*M_PI-0)*phi1;
          phi2=0 +(2*M_PI-0)*phi2;
          funk=(*function)(r1,r2,theta1, theta2, phi1, phi2);
          MCint+=funk;
          MCint_vek[i]=funk;
          //cout<<funk<<endl;
